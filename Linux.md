...
| `journalctl -p [level]` | Filter logs by priority/severity level (e.g.,  "emerg" (0), "alert" (1),
"crit" (2), "err" (3), "warning" (4), "notice" (5), "info" (6), "debug" (7)) |	`journalctl -p err -b` (Shows only error logs from the current boot) |
